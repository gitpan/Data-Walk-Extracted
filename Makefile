# This Makefile is for the Data::Walk::Extracted extension to perl.
#
...
#     ABSTRACT => q[An extracted dataref walker]
#     AUTHOR => [q[Jed Lund <jandrew@cpan.org>]]
#     BUILD_REQUIRES => { Moose::Util=>q[0], Modern::Perl=>q[0], Capture::Tiny=>q[0], Test::Moose=>q[0], Test::Most=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.30] }
#     DISTNAME => q[Data-Walk-Extracted]
#     EXE_FILES => []
#     LICENSE => q[perl]
#     NAME => q[Data::Walk::Extracted]
#     PREREQ_PM => { Moose::Role=>q[0], MooseX::Types::Moose=>q[0], Capture::Tiny=>q[0], version=>q[0], Carp=>q[0], YAML::Any=>q[0], Modern::Perl=>q[0], Moose::Util=>q[0], MooseX::StrictConstructor=>q[0], Test::Moose=>q[0], Test::Most=>q[0], Smart::Comments=>q[0], Moose=>q[0] }
#     VERSION => q[v0.011_001]
#     test => { TESTS=>q[t/*.t] }
...
NAME_SYM = Data_Walk_Extracted
VERSION = v0.011_001
VERSION_MACRO = VERSION
VERSION_SYM = v0_011_001
DEFINE_VERSION = -D$(VERSION_MACRO)=\"$(VERSION)\"
XS_VERSION = v0.011_001
...
MAKE = dmake
FULLEXT = Data\Walk\Extracted
BASEEXT = Extracted
PARENT_NAME = Data::Walk
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
INST_LIBDIR      = $(INST_LIB)\Data\Walk
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Data\Walk
...
TO_INST_PM = README.pod \
	lib/Data/Walk/Clone.pm \
	lib/Data/Walk/Extracted.pm \
	lib/Data/Walk/Graft.pm \
	lib/Data/Walk/Print.pm \
	lib/Data/Walk/Prune.pm \
	lib/Data/Walk/Thin.pm \
	lib/Data/Walk/Top.pm

PM_TO_BLIB = lib/Data/Walk/Top.pm \
	blib\lib\Data\Walk\Top.pm \
	README.pod \
	$(INST_LIB)\Data\Walk\README.pod \
	lib/Data/Walk/Prune.pm \
...
DISTVNAME = Data-Walk-Extracted-v0.011_001
...
Extracted.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Data::Walk::Extracted\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: \"An extracted dataref walker\r\"" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "- Jed Lund <jandrew@cpan.org>" >> META_new.yml
	$(NOECHO) $(ECHO) build_requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Capture::Tiny: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Modern::Perl: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Moose::Util: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  Test::Moose: '0'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Data-Walk-Extracted" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "  Smart::Comments: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  YAML::Any: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "  version: '0'" >> META_new.yml
	$(NOECHO) $(ECHO) "version: v0.011_001" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) {{ > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"An extracted dataref walker\r\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Jed Lund ^<jandrew^@cpan.org^>\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Data-Walk-Extracted\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "            \"Modern::Perl\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Moose::Util\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Test::Moose\" : \"0\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "            \"Smart::Comments\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"YAML::Any\" : \"0\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"version\" : \"0\"" >> META_new.json
	$(NOECHO) $(ECHO) "         }}" >> META_new.json
	$(NOECHO) $(ECHO) "      }}" >> META_new.json
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"release_status\" : \"testing\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"version\" : \"v0.011_001\"" >> META_new.json
	$(NOECHO) $(ECHO) }} >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"v0.011_001\">" > $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>An extracted dataref walker</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Jed Lund &lt;jandrew@cpan.org&gt;</AUTHOR>" >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"MooseX::StrictConstructor\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"MooseX::Types::Moose\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Smart::Comments\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"YAML::Any\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Data/Walk/Top.pm blib\lib\Data\Walk\Top.pm \
	  README.pod $(INST_LIB)\Data\Walk\README.pod \
	  lib/Data/Walk/Prune.pm blib\lib\Data\Walk\Prune.pm \
	  lib/Data/Walk/Print.pm blib\lib\Data\Walk\Print.pm \
	  lib/Data/Walk/Clone.pm blib\lib\Data\Walk\Clone.pm \
	  lib/Data/Walk/Extracted.pm blib\lib\Data\Walk\Extracted.pm \
	  lib/Data/Walk/Graft.pm blib\lib\Data\Walk\Graft.pm \
	  lib/Data/Walk/Thin.pm blib\lib\Data\Walk\Thin.pm 
